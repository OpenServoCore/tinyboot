 ...
 *
 * The bootloader occupies the first 8KB of the 32KB user flash, with
 * boot metadata (state, trial counter) in the last page of that region.
 * The remaining 24KB is entirely available for the application.
 *
 ...
 *   0x0800_2000 .. 0x0800_7FFF  application 24KB
 */
MEMORY
{
