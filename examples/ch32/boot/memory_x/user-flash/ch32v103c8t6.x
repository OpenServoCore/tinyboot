 ...
 *
 * The bootloader occupies the first 8KB of the 64KB user flash, with
 * boot metadata (state, trial counter) in the last page of that region.
 * The remaining 56KB is entirely available for the application.
 *
 ...
 *   0x0800_2000 .. 0x0800_FFFF  application 56KB
 */
MEMORY
{
